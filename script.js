document.addEventListener('DOMContentLoaded', function () {
    const CONFIG = {
        ...
        SPOTIFY_CLIENT_ID: 'ca69d16bf0ab408f9d311f56c7e411f7',
    ...
    function updateDiscordUI(userData) {
        ...
        if (userData.discord_user) {
            ...
            const discordUsername = userData.discord_user.username || 'piolhoot';
                ...
                if (userData.activities && userData.activities.length > 0) {
                    ...
                    if (filteredActivities.length > 0) {
                        ...
                        switch (currentActivity.type) {
                            case 0:
                                activityText = `🎮 Jogar${currentActivity.name}`;
                                ...
                                break;
                            case 1:
                                activityText = `🔴 Transmissão${currentActivity.name}`;
                                if (activityImage) activityImage.style.display = 'none';
                                break;
                            case 2:
                                activityText = `🎵 Ouvindo${currentActivity.name}`;
                                if (activityImage) activityImage.style.display = 'none';
                                break;
                            case 3:
                                activityText = `📺 Olhar${currentActivity.name}`;
                                if (activityImage) activityImage.style.display = 'none';
                                break;
                            default:
    ...
    function updateDiscordUIFromLookup(userData) {
        console.log('🎨 Atualização da interface do usuário do Discord com Lookup:', userData);
    ...
    function updateDiscordUIFromAPI(userData) {
        console.log('🎨 Atualização da interface do usuário do Discord com API:', userData);
    ...
    function updateDiscordOffline() {
        console.log('😴 Modo Discord Offline');
